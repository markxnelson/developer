...
This workshop introduces you to the Kafka Java Client for Oracle Database Transactional Event Queues, a Kafka-compatible API for high-throughput event streaming in Oracle AI Database.
